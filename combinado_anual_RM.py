...
for i in range(len(lista_area_telhado)):
    ...
    # tQin = Qin_file.tolist()  # tirar isso. tQin sera = vazao_biorretencao
    ...
    for j in range(len(lista_vol_reservatorio)):
        ...
        lista_todos_telhados.append(Area_telhado)       #trocar "area_telhado" pelo mesmo nome da sua variavel
        lista_todos_volumes.append(volume_reservatorio) #trocar "volume_reservatorio" pelo mesmo nome da sua variavel
...
dados_do_sistema.to_csv('infos_sistema_RM_hadgem8.5_2048.csv', index=False, sep=';', decimal=',')
